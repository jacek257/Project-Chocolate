...
txt_files = [file for file in os.listdir(path) if file.lower().endswith('edits.txt')]
...
#            
#            try:
#                cz1 = pd.read_csv(feat_output_dir+'cluster_zstat1_std.txt', sep='\t', usecols=['Voxels', '-log10(P)', 'Z-MAX', 'COPE-MEAN'])
...
#            
#            try:
#                cz2 = pd.read_csv(feat_output_dir+'cluster_zstat2_std.txt', sep='\t', usecols=['Voxels', '-log10(P)', 'Z-MAX', 'COPE-MEAN'])
